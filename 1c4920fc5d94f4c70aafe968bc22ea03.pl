...
% Predicate : neighbours(Country, Neighbours).
% Determines the list of Neighbours of a Country.

neighbours(austria        , [germany, italy, slovenia, czech_republic, slovakia, hungary]).
neighbours(belgium        , [france, netherlands, luxemburg, germany, united_kingom]).
...
neighbours(france         , [spain, belgium, luxemburg, germany, italy, united_kingom]).
neighbours(germany        , [netherlands, belgium, luxemburg, denmark, france, austria]).
neighbours(greece         , [bulgaria, cyprus]).
neighbours(hungary        , [austria, slovakia, romania, croatia, slovenia]).
neighbours(ireland        , [united_kingom]).
neighbours(italy          , [france, austria, slovenia]).
neighbours(latvia         , [estonia, lithuania]).
neighbours(luxemburg      , [belgium, france, germany]).
neighbours(malta          , []).
neighbours(netherlands    , [belgium, germany , united_kingom]).
...
neighbours(united_kingom  , [ireland, netherlands, belgium, france]).
